...
The project is focused on building a mobile phone application on the Android platform. The customer gave a description of the application to focus on the Land Registry database showing the ownership of property in England and Wales. It stated the application should be able to detect the phone's location and automatically display Price paid data of residential property sales close to the phones' locations through a heat map overlay on Google Maps. 
